...
class prioritQueue:
    ...
    def __percolateDown(self):
        ...
        while leftchildIndex < self.size():
            ...
            if rightchildIndex < self.size() and l[rightchildIndex].priority < l[minIndex].priority:
...
for i in range(n):
    l = [int(ele) for ele in input().split()] #the case for adding strings as value isn't working instead isert manually
    p.insert(l[0],l[1])'''
